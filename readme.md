...
resource "aws_lambda_layer_version" "chrome_aws_layer" {
  ...
  s3_key    = "lambda-layer-chrome-aws/lambda-layer-chrome-aws-v143.0.4.x64.zip"
}
...
resource "aws_lambda_layer_version" "chrome_aws_layer" {
  ...
  s3_bucket = "YOUR_BUCKET_NAME"
  s3_key    = "lambda-layer-chrome-aws/lambda-layer-chrome-aws-v143.0.4.arm64.zip"
}
